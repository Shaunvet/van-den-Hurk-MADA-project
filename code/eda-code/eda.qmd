...
saveRDS(hist_age_group_1, here::here("data", "processed-data", "hist_age_group_1.rds"))
#Print histogram
...
saveRDS(hist_age_group_2, here::here("data", "processed-data", "hist_age_group_2.rds"))
# Print histogram 2
...
ggsave(here::here("results", "figures", "mortality_by_race.png"), plot = race_plot)
print(race_plot)

```
This is the same but without sex and the colours for a neater output.
...
saveRDS(national_age_trend, here::here("data", "processed-data", "national_trend_by_age.rds"))
...
saveRDS(race_trend_65_plus, here::here("data", "processed-data", "race_trend_65_plus.rds"))
...
saveRDS(race_trend_35_64, here::here("data", "processed-data", "race_trend_35_64.rds"))
...
saveRDS(sex_trend_65_plus, here::here("data", "processed-data", "sex_trend_65_plus.rds"))
...
saveRDS(sex_trend_35_64, here::here("data", "processed-data", "sex_trend_35_64.rds"))
...
gtsave(grouped_summary_clean, here::here("results", "tables", "summary_mortality_table.png"))
...
saveRDS(yearly_means, here::here("data", "processed-data", "yearly_means.rds"))
```
